...
NEWS_JSON_PATH = 'C:/Users/arkad/PycharmProjects/HyperNews Portal/HyperNews Portal/task/hypernews/news/news.json'  # You can choose any path you want
...
TEMPLATES = [
    {
        ...
        'DIRS': ['C:/Users/arkad/PycharmProjects/HyperNews Portal/HyperNews Portal/task/hypernews/news/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
